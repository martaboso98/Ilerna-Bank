...
<body>
    ...
    <section id="prestamosAdmin">
        <div class="contenedorPrestamosAdmin px-5 my-5">
            <h1 class="text-center p-2 text-white">PRÉSTAMOS</h1>
            <div class="prestamos">
                <?php include("consultas/consultaPrestPend.php"); ?>
            </div>
            <div class="prestamos">
                <?php include("consultas/consultaPrestComp.php"); ?>
            </div>
        </div>
    </section>
            ...
            <div class="container text-center text-md-start p-2">
                <div class="row mt-3">
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <p>Con Boso Financial Services puedes sacar dinero en muchos lugares. Encuentra tu cajero más
                            cercano.</p>
                    </div>
